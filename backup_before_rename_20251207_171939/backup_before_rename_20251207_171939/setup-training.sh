#!/bin/bash
# QuetzalCore Training System - Interactive Setup & Demo
...
echo ""
echo "Welcome to the QuetzalCore Training System!"
echo ""
echo "This system provides TWO powerful training solutions:"
echo ""
echo -e "${GREEN}1. QTM (QuetzalCore Training Manager)${NC}"
...
while true; do
    ...
    case $choice in
        ...
        6)
            echo ""
            echo -e "${GREEN}Thank you for using QuetzalCore Training System!${NC}"
            echo ""

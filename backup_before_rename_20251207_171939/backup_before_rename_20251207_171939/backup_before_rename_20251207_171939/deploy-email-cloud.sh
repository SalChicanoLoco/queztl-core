#!/bin/bash
# Deploy QuetzalCore Email System - Complete Setup

echo "🚀 QuetzalCore Email - Full Cloud Deployment"
echo "========================================"
echo ""
...
case $choice in
    1)
        ...
        echo "7. Deploy!"
        echo ""
        echo "8. Copy the URL (e.g., quetzalcore-email.railway.app)"
        echo ""
    ...
    2)
        ...
        echo "3. Connect GitHub → quetzalcore-core"
        echo "4. Settings:"
        echo "   - Name: quetzalcore-email"
        ...
        echo ""
        echo "7. Copy the URL (e.g., quetzalcore-email.onrender.com)"
        echo ""

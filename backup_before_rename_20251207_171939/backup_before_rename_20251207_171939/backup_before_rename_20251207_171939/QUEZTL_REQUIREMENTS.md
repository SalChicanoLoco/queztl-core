# 🦅 Queztl Core - Real Requirements Analysis

## What You Actually Need

### Problem Statement
You need Queztl to be **scalable** to handle:
...
### 1. Where is Queztl Core physically?
...
**Code needed:**
- `queztl_master.py` - Receives jobs, routes to workers
- `queztl_worker.py` - Executes jobs, reports results
...
**Tell me:**
1. Do you have Queztl worker nodes set up? (servers/VMs ready to use)

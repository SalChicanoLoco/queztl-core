#!/bin/bash
# 🌐 Quick Web Deployment Script for QuetzalCore-Core 3DMark Benchmark

echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🦅 QUETZALCORE-CORE WEB DEPLOYMENT"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
...
test_local() {
    ...
    echo "   - Or set API URL to production: https://quetzalcore-core-api.onrender.com"
}
...
generate_standalone() {
    ...
    cp dashboard/public/3dmark-benchmark.html quetzalcore-3dmark-standalone.html
    
    echo -e "${GREEN}✅ Generated: quetzalcore-3dmark-standalone.html${NC}"
    echo ""
    echo "You can:"
    ...
    echo ""
    echo "File location: $(pwd)/quetzalcore-3dmark-standalone.html"
}

# 🦅 QUEZTL OS - AGILE SCRUM QUICKSTART
...
- 🎯 Sprint 1: "Hello Queztl" - Bootable kernel (10 points)
...
**Sprint 1: "Hello Queztl" (Dec 7-20, 2025)**
- ✅ Boot Queztl OS from bootloader
...
1. **US-1**: Boot Queztl OS (5 points) - 🔄 IN PROGRESS
...
```bash
# Build kernel
cd queztl-kernel && cargo build --release

# Run tests
cargo test --release

# Boot test (requires QEMU)
qemu-system-x86_64 -kernel target/release/queztl-kernel -serial stdio -display none
```
...
# 4. Test: echo "Hello from Queztl!"
```

### US-4: Version Info (2 points)
**Acceptance Criteria:**
- [ ] Display "Queztl OS v1.0" on boot
...
# During Development
1. Edit files in queztl-kernel/src/
...
2. Update story status in QUEZTL_AGILE_SCRUM.md
